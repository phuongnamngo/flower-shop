                        ...
                        <div class="col-md-8 address_form_agile ps-lg-5">
                                    ...
                                    <div class="first-row form-group">
                                        <div class="w3_agileits_card_number_grids">
                                            ...
                                            <div class="w3_agileits_card_number_grid_left">
                                                <div class="controls">
                                                    <input class="form-control" name="shipping_address" type="text" placeholder="Shipping Address" required>
                                                </div>
                                            </div>
                                            <div class="clear"></div>
                                        </div>
                            ...
                            <div class="vertical_post">
                                ...
                                <div class="swit-radio mt-4">
                                    <div class="check_box_one w-50">
                                        <div class="radio_one"> <label class="h5"><input class="me-1" type="radio" name="radio" checked="" value="delivery"><i></i>Thanh toán khi nhận hàng</label> </div>
                                    </div>
                                    <div class="check_box_one w-50">
                                        <div class="radio_one"> <label class="h5"><input class="me-1" type="radio" name="radio" value="momo"><i></i>Thanh toán bằng MoMo</label> </div>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            <div class="checkout-right-basket m-0">
                                <button class="btn btn-style btn-primary mx-3">Payment<i class="fas fa-arrow-right ms-lg-3 ms-2"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
