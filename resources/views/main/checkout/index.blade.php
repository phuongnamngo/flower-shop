            ...
            <div class="ecom-contenthny-w3lcheckout privacy">
                ...
                <div class="row checkout-left mt-5">
                    ...
                    <div class="col-md-8 address_form_agile ps-lg-5">
                        ...
                        <form action="{{ route('checkout.store') }}" method="POST" class="creditly-card-form agileinfo_form mt-4">
                            @csrf
                                ...
                                <div class="information-wrapper">
                                    <div class="first-row form-group">
                                        ...
                                        <div class="w3_agileits_card_number_grids">
                                            ...
                                            <div class="w3_agileits_card_number_grid_left">
                                                <div class="controls">
                                                    <input class="form-control" name="customer_phone" type="text" placeholder="Mobile number" required>
                                                </div>
                                            </div>
                            ...
                            <div class="checkout-right-basket m-0">
                                <button class="btn btn-style btn-primary" type="submit">Payment<i class="fas fa-arrow-right ms-lg-3 ms-2"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
