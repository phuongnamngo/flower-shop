            ...
            <div class="col-lg-10 col-xl-8">
                ...
                <div class="card" style="border-radius: 10px;">
                    <div class="card-header px-4 py-4">
                        <h5 class="text-muted mb-0">Thanks for your Order - <span style="color: #ef233c;">{{ $user->name }}</span>!</h5>
                    </div>
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <p class="small text-muted mb-0">Order ID: {{ $orderItem->idOrder }} </p>
                        ...
                        <div class="card shadow-0 border mb-4">
                            <div class="card-body">
                                <div class="row justify-content-between align-items-center">
                                    ...
                                    <div class="col text-center d-flex justify-content-center align-items-center">
                                        <p class="text-muted mb-0 ">${{ number_format($orderItem->price) }}</p>
                                    </div>
