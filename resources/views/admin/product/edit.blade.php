                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="Nhập danh mục" name="name" value="{{$product->name}}">
                                        @if ($errors->has('name'))
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="Nhập danh mục" name="price" value="{{$product->price}}">
                                        @if ($errors->has('price'))
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="Nhập danh mục" name="desc" value="{{$product->desc}}">
                                        @if ($errors->has('desc'))
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="Nhập danh mục" name="content" value="{{$product->content}}">
