            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="d-flex align-items-center justify-content-between px-4 pt-4 pb-2">
                        ...
                        <a href="{{route('admin.blog.create')}}" class="btn btn-primary m-0">Thêm</a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <div class="form-check form-switch justify-content-center">
                                                @if($item->status == 1)
                                                <input class="form-check-input blog_status" type="checkbox" id="{{ $item->id }}" value="0" checked>
                                                @else
                                                <input class="form-check-input blog_status" type="checkbox" id="{{ $item->id }}" value="1">
                                                @endif
                                            </div>
                                        </td>
                                        <td class="align-middle text-center">
                                            <form action="{{ route('admin.blog.destroy',$item->id) }}" method="POST">
                                                <a class="btn btn-success mb-0" href="{{ route('admin.blog.edit',$item->id) }}">Điều chỉnh</a>
